...
export default function ProjectsShowcase() {
  const projects = [
    ...
    {
      id: 2,
      projectType: '250 kW Commercial Rooftop',
    ...
    {
      id: 3,
      projectType: '15 kW Agricultural Pump System',
    ...
    {
      id: 4,
      projectType: '150 kW Commercial Rooftop',
    ...
    {
      id: 5,
      projectType: '40 kW Commercial Carport Setup',
    ...
    {
      id: 6,
      projectType: '50 kW Agrivoltaic Farm Setup',
    ...
    {
      id: 7,
      projectType: '8 kW Residential Rooftop',
    ...
    {
      id: 8,
      projectType: '12 kW Commercial Rooftop',
    ...
    {
      id: 9,
      projectType: '20 kW Commercial Setup',
    ...
    {
      id: 10,
      projectType: '6 kW Agricultural Pump System',
    ...
    {
      id: 11,
      projectType: '15 kW Hybrid Solar Solution',
    ...
    {
      id: 12,
      projectType: '100 kW Industrial Rooftop',
